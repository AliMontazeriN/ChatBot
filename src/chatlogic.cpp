...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // learned the solution "const std::unique_ptr<GraphNode> &node" form UDACITY knowledge portal
    ...
    ChatBot movingChatBot("../images/chatbot.png");
    movingChatBot.SetRootNode(rootNode);
    movingChatBot.SetChatLogicHandle(this);
    rootNode->MoveChatbotHere(std::move(movingChatBot));
    ////
    //// EOF STUDENT CODE
}
